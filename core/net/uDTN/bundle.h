...
/* Bundle Priorities */
#define BUNDLE_PRIORITY_BULK			0x0000
#define BUNDLE_PRIORITY_NORMAL			0x0080
#define BUNDLE_PRIORITY_EXPEDITED		0x0100
#define BUNDLE_PRIORITY_RESERVED		0x0180

#define BUNDLE_PRIORITY_MASK			0x0180
