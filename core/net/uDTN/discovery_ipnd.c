...
uint8_t discovery_ipnd_is_neighbour(rimeaddr_t * dest)
{
	...
	//	printf("discovery_ipnd_is_neighbour. No inicializado\n");
		// Not initialized yet
		return 0;
	}
...
/**discovery_basic_neighbour_list_entry
...
//	printf("discovery_ipnd_save_neigbour. Voy a agregar al vecino %u.%u\n",neighbour->u8[0],neighbour->u8[1]);

	list_add(neighbour_list, entry);


	discovery_ipnd_print_list();
